      ...
      <section className='flex flex-col md:flex-row items-center justify-center py-0 md:py-8 px-4 text-left max-w-6xl mx-auto'>
        ...
        <div>
          ...
          <p className='text-lg md:text-xl text-gray-300 leading-relaxed max-w-2xl'>
            ...
            Who is Meowtin besides someone who refers to himself in the third person? Well, he is a
            creative professional with a passion for performance, music, and visual storytelling. He
            is an accomplished musician, karaoke host, emcee, DJ, music producer, video producer,
            web site and mobile app builder, and music venue owner. Aside from his professional
            accomplishments, Meowtin prides himself as well travelled, a lover of people and life,
            yoga and meditation enthusiast, pro wrestling connoisseur, video game devotee, and all
            around good guy.
          </p>
        </div>
      </section>
