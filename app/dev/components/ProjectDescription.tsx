  ...
  return (
    <div ref={ref} className='fixed top-0 left-0 w-full h-screen flex items-center justify-center'>
      ...
      >
        ...
        <div
          className={`flex flex-col items-center justify-center gap-8 md:gap-12 max-w-4xl px-6 py-8 md:px-8 md:py-10 mx-4 
        ...
        >
          ...
          <div className='w-full'>
            <p
              ...
              } text-white/90 leading-relaxed whitespace-pre-line text-center`}
            >
              {project.description}
            </p>
          </div>
          ...
          <div className='w-full'>
            <h3
              ...
              } font-semibold text-center text-[#00ffaa] mb-4`}
            >
              Technologies Used
            </h3>
            <div className='flex flex-wrap justify-center gap-2 md:gap-3'>
              {project.technologies.map((tech, index) => (
                <div
                  key={index}
                  className={`px-3 py-1 md:px-4 md:py-2 bg-white/10 rounded-full text-white backdrop-blur-sm border border-gray-700/50 ${
